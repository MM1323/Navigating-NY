...
$(document).ready(function(){
        $('#search').click(function(){
            ...
            for (var i=1; i<= 9; i++){
               ...
               // $('#appended_results').append('<li>' + 'You can go to ' + restaurant_name + "." + " " + 'You can call them at ' + restaurant_phone + "." + " " + 'There address is  ' + restaurant_adress + "." + '</li>');
               ...
               $('#appended_results').append('<li>' + 'You can call them at ' + restaurant_phone + "</li>")
               $('#appended_results').append('<li>' + 'There address is  ' + restaurant_adress + "</li>" + "<br>")
